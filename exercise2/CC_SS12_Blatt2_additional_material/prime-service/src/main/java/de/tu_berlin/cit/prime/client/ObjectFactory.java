 ...
 * generated in the de.tu_berlin.cit.prime.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _IsPrimeResponse_QNAME = new QName("http://server.prime.cit.tu_berlin.de/", "isPrimeResponse");
    private final static QName _IsPrime_QNAME = new QName("http://server.prime.cit.tu_berlin.de/", "isPrime");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.tu_berlin.cit.prime.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.prime.cit.tu_berlin.de/", name = "isPrimeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.prime.cit.tu_berlin.de/", name = "isPrime")
